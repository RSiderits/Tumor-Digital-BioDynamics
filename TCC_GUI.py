...
layout=[
        [sg.Image(filename=("DNA2.png"), size=(200,200), pad=(20,10)), 
         ...
         sg.Input(" Default values", size=(15,1), border_width=7, 
         text_color="yellow", enable_events=True, key="-ID-", 
         background_color="black")],
       
        # Get input for parameters: -------------------------------------------
            
        [sg.Input(default_text="1", key="-TS-", size=(5,1), text_color="green1", 
                  enable_events=True,tooltip="Enter size of lesion in cm" ),    
        sg.Text("Tumor size in cm (1-10 cm)", size=(25,1))],  
        
        [sg.Input(default_text="25",key="-CS-", size=(5,1), text_color="green1", 
                  enable_events=True),
        sg.Text("Average tumor cell size in microns (1-100 um)", size=(35,1))], 
       
        [sg.Input(default_text="10",key="-PS-", size=(5,1), text_color="green1", 
                  enable_events=True), 
        sg.Text("Percent stroma (1-99%)", size=(20,1))],  
  
        [sg.Input(default_text="10", key="-NT-", size=(5,1), text_color="green1", 
                  enable_events=True),
        sg.Text("Percent stromal cellularity (1-99%)", size=(25,1))],         
   
        [sg.Input(default_text="85",key="-EE-", size=(5,1), text_color="green1", 
                  enable_events=True),
        ...
        [sg.Button("Calculate", key="-Calc-", pad=(10,25), size=20, font="Arial,12"), 
        ...
        [sg.Text("Estimated DNA if Enhcanced for Tumor, in a 100um thick setion pg DNA:"), 
...
while True:
 ...
 # Number of cells that could be in the sample cylinder, NOT compensated for stroma
 ...
 # Number 10um thick sections of enhanced for tumor sample, assure 100ng gDNA for sequencing
...
# print(f"Number tumor cells Compensated for {v2} % stroma is:", '{:,}'.format(comp_number_cells))
# print("--------------------------------------------------------------")
# print("Cylinder volume in um3:", '{:,}'.format(VC))
# print("Cells in Cylinder: ", '{:,}'.format(CC))
# print("--------------------------------------------------------------")
# print("Picograms DNA in entire tumor (stroma compensated, 6pg/cell):" ,'{:,}'.format( PT))
...
# print("# of 10um thick, enhanced for Tumor, sections for 1000ng Tumor DNA:", sgDNA)
# print("Sample Id:", )
window.close()
